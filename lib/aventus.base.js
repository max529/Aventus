...
class AvHideable extends WebComponent {
    ...
    __prepareMutablesActions() {
					this.__mutableActions["isVisible"] = [((target) => {    target.dispatchEvent(new CustomEvent("toggle_visibility", { detail: { visible: target.isVisible } }));})];
