...
class AvPage extends WebComponent {
    ...
    __defaultValueAttr() { super.__defaultValueAttr(); if(!this.hasAttribute('show')) { this.attributeChangedCallback('show', false, false); } }
