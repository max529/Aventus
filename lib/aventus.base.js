...
class AvScrollable extends WebComponent {
    ...
    __defaultValue() { super.__defaultValue(); if(!this.hasAttribute('floating_scroll')) { this.attributeChangedCallback('floating_scroll', false, false); }if(!this.hasAttribute('only_vertical')) { this.attributeChangedCallback('only_vertical', false, false); } }
