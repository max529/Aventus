...
class AvHideable extends WebComponent {
    get 'isVisible'() {
						return this.__mutable["isVisible"];
					}
					set 'isVisible'(val) {
						/*if (this.__mutable["isVisible"]) {
							this.__mutable["isVisible"].__unsubscribe(this.__mutableActionsCb["isVisible"]);
						}*/
						this.__mutable["isVisible"] = val;
						if (val) {
							//this.__mutable["isVisible"] = Object.transformIntoWatcher(val, this.__mutableActionsCb["isVisible"]);
							//this.__mutableActionsCb["isVisible"](MutableAction.SET, '', this.__mutable["isVisible"]);
						}
						else{
							//this.__mutable["isVisible"] = undefined;
						}
    ...
    __prepareMutablesActions() {
					this.__mutableActions["isVisible"] = [((target) => {    target.onVisibilityChangeCallbacks.forEach(callback => callback(target.isVisible));})];
						this.__mutableActionsCb["isVisible"] = (action, path, value) => {
							for (let fct of this.__mutableActions["isVisible"]) {
