...
class AvRouterLink extends WebComponent {
    ...
    __defaultValueAttr() { super.__defaultValueAttr(); if(!this.hasAttribute('state')){ this['state'] = ''; }if(!this.hasAttribute('active_state')){ this['active_state'] = ''; } }
...
window.customElements.define('av-router-link', AvRouterLink);WebComponent.registerDefinition(AvRouterLink);
...
class AvPage extends WebComponent {
    ...
    __registerOnChange() { super.__registerOnChange(); this.__onChangeFct['show'] = []this.__onChangeFct['show'].push((path) => {((target) => {    if (target.show) {        target.onShow();    }    else {        target.onHide();    }})(this);}) }
    getClassName() {
        return "AvPage";
    }
    __defaultValueProp() { super.__defaultValueProp(); if(!this.hasAttribute('show')) { this.attributeChangedCallback('show', false, false); } }
...
class AvFormElement extends WebComponent {
    ...
    get 'required'() {
                ...
                this.__watchActions["value"] = [((target, action, path, value) => {    target.onValueChanged();})];
    ...
    __defaultValueAttr() { super.__defaultValueAttr(); if(!this.hasAttribute('required')) { this.attributeChangedCallback('required', false, false); }if(!this.hasAttribute('name')){ this['name'] = ''; }if(!this.hasAttribute('focusable')) { this.attributeChangedCallback('focusable', false, false); } }
