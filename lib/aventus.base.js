...
class AvRouterLink extends WebComponent {
    __prepareVariables() { super.__prepareVariables(); if(this.state === undefined) {this.state = "";} }
    __getStyle() {
        let arrStyle = super.__getStyle();
        arrStyle.push(``);
        return arrStyle;
...
class AvPage extends WebComponent {
    ...
    __prepareVariables() { super.__prepareVariables(); if(this.show === undefined) {this.show = undefined;} }
    __getStyle() {
        let arrStyle = super.__getStyle();
...
class AvFormElement extends WebComponent {
    ...
    __prepareVariables() { super.__prepareVariables(); if(this.required === undefined) {this.required = false;}if(this.name === undefined) {this.name = "";}if(this.focusable === undefined) {this.focusable = false;}if(this.value === undefined) {this.value = {"name":"this.getDefaultValue","arguments":[]};}if(this.errors === undefined) {this.errors = [];} }
    __getStyle() {
        let arrStyle = super.__getStyle();
        arrStyle.push(``);
        return arrStyle;
