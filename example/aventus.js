...
class AvScrollable extends WebComponent {
    ...
    get elToCalculate () {
                        var list = Array.from(this.shadowRoot.querySelectorAll('[_id="avscrollable_0"]'));
                        if(list.length == 1){
                            list = list[0]
                        }
                        return list;
                    }get contentZoom () {
                        var list = Array.from(this.shadowRoot.querySelectorAll('[_id="avscrollable_1"]'));
                        if(list.length == 1){
                            list = list[0]
                        }
                        return list;
                    }get contentHidder () {
                        var list = Array.from(this.shadowRoot.querySelectorAll('[_id="avscrollable_2"]'));
                        if(list.length == 1){
                            list = list[0]
                        }
                        return list;
                    }get contentWrapper () {
                        var list = Array.from(this.shadowRoot.querySelectorAll('[_id="avscrollable_3"]'));
                        if(list.length == 1){
                            list = list[0]
                        }
                        return list;
                    }get contentscroller () {
                        var list = Array.from(this.shadowRoot.querySelectorAll('[_id="avscrollable_4"]'));
                        if(list.length == 1){
                            list = list[0]
                        }
                        return list;
                    }get verticalScrollerContainer () {
                        var list = Array.from(this.shadowRoot.querySelectorAll('[_id="avscrollable_5"]'));
                        if(list.length == 1){
                            list = list[0]
                        }
                        return list;
                    }get verticalScroller () {
                        var list = Array.from(this.shadowRoot.querySelectorAll('[_id="avscrollable_6"]'));
                        if(list.length == 1){
                            list = list[0]
                        }
                        return list;
                    }get horizontalScrollerContainer () {
                        var list = Array.from(this.shadowRoot.querySelectorAll('[_id="avscrollable_7"]'));
                        if(list.length == 1){
                            list = list[0]
                        }
                        return list;
                    }get horizontalScroller () {
                        var list = Array.from(this.shadowRoot.querySelectorAll('[_id="avscrollable_8"]'));
                        if(list.length == 1){
                            list = list[0]
                        }
                        return list;
...
<div _id="avhideable_0"></div>`
    ...
    get content () {
                        var list = Array.from(this.shadowRoot.querySelectorAll('[_id="avhideable_0"]'));
                        if(list.length == 1){
                            list = list[0]
                        }
                        return list;
